...
* [Please rate WP Progress Bar plugin](https://wordpress.org/support/view/plugin-reviews/wp-progress-bar#postform)
...
1. Upload 'wp-progress-bar' folder to the '/wp-content/plugins/' directory.
